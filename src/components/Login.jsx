...
const Login = () => {
    ...
    return (
        <div style={{backgroundImage: `url(${images.login})`}} className='w-full min-h-[calc(100dvh-128px)] bg-center bg-cover flex justify-center items-center gap-[40px]'>
            <div className='ml-[10%] border border-white/60 h-[calc(100dvh-300px)]'></div>
